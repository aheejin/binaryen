    ...
    function i64Equal(actual_lo, actual_hi, expected_lo, expected_hi) {
      console.log(actual_lo);
      console.log(expected_lo);
...
function asmFunc0(global, env, buffer) {
 ...
 function legalstub$0($0_1, $1, $2, $3) {
  ...
  i64toi32_i32$2 = $12;
  console.log("same = " + i64toi32_i32$2);
  ...
  console.log("diff = " + i64toi32_i32$2);
...
var retasmFunc0 = asmFunc0({Math,Int8Array,Uint8Array,Int16Array,Uint16Array,Int32Array,Uint32Array,Float32Array,Float64Array,NaN,Infinity}, {abort:function() { throw new Error('abort'); },setTempRet0,getTempRet0},memasmFunc0);
function check1() {
 return i64Equal(retasmFunc0.rem_s(5,0, 2,0), retasmFunc0.__wasm_fetch_high_bits() | 0 | 0, 1,0) | 0 | 0;
}

if (!check1()) throw 'assertion failed: ( assert_return ( call rem_s ( i64.const 5 ) ( i64.const 2 ) ) ( i64.const 1 ) )';
